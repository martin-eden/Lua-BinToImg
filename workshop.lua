...
--[[
  ...
  ['workshop.concepts.Image.Color.BlackWhite'] = [=[
-- Black/white color structure
...
--[[
  ...
  ['workshop.concepts.Image.Interface'] = [=[
...
--[[
  ...
  ['workshop.concepts.Image.Settings.Interface'] = [=[
